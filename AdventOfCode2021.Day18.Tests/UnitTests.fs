...
let ``1-1 Test part1 with sample`` () =
    (-1, (Solution.part1 (getSample ())))
    |> Assert.AreEqual

[<Test>]
let ``1-2 Test part1 with inputs`` () =
    (-1, (Solution.part1 (getInputs ())))
    |> Assert.AreEqual

[<Test>]
let ``2-1 Test part1 with sample`` () =
    (-1, (Solution.part2 (getSample ())))
    |> Assert.AreEqual

[<Test>]
let ``2-2 Test part1 with inputs`` () =
    (-1, (Solution.part2 (getInputs ())))
    |> Assert.AreEqual
...
let ``Check: reduce`` _ before after =
    ...
    test
        <@ before
           |> Solution.parseNumber
           |> Solution.reduce 1<Level>
...
[<TestCase(104, "[[[0,[4,5]],[0,0]],[[[4,5],[2,6]],[9,5]]]+[7,[[[3,7],[4,3]],[[6,3],[8,8]]]]", "[[[[4,0],[5,4]],[[7,7],[6,0]]],[[8,[7,7]],[[7,9],[5,0]]]]")>]
[<TestCase(105,
...
[<TestCase(108, "[[[[7,7],[7,8]],[[9,5],[8,7]]],[[[6,8],[0,8]],[[9,9],[9,0]]]]+[[2,[2,2]],[8,[8,1]]]", "[[[[6,6],[6,6]],[[6,0],[6,7]]],[[[7,7],[8,9]],[8,[8,1]]]]")>]
[<TestCase(109, "[[[[6,6],[6,6]],[[6,0],[6,7]]],[[[7,7],[8,9]],[8,[8,1]]]]+[2,9]", "[[[[6,6],[7,7]],[[0,7],[7,7]]],[[[5,5],[5,6]],9]]")>]
[<TestCase(110,
           "[[[[6,6],[7,7]],[[0,7],[7,7]]],[[[5,5],[5,6]],9]]+[1,[[[9,3],9],[[9,0],[0,7]]]]",
           "[[[[7,8],[6,7]],[[6,8],[0,8]]],[[[7,7],[5,0]],[[5,5],[5,6]]]]")>]
[<TestCase(111, "[[[[7,8],[6,7]],[[6,8],[0,8]]],[[[7,7],[5,0]],[[5,5],[5,6]]]]+[[[5,[7,4]],7],1]", "[[[[7,7],[7,7]],[[8,7],[8,7]]],[[[7,0],[7,7]],9]]")>]
[<TestCase(112, "[[[[7,7],[7,7]],[[8,7],[8,7]]],[[[7,0],[7,7]],9]]+[[[[4,2],2],6],[8,7]]", "[[[[8,7],[7,7]],[[8,6],[7,7]]],[[[0,7],[6,6]],[8,7]]]")>]
[<TestCase(113,
